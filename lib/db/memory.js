 ...
 *    <scope>: {
 *      scope: <scope>,
 *      epochAccessKey: <epochAccessKey>,
 *      description: <description>,
 *      canGrantScopedKeys: <canGrantScopedKeys>,
 *      createdAt: <timestamp>
 *    }
 * }
 */
...
MemoryStore.prototype = {
  ...
  registerScope: function registerApplicationScope (scope) {
    scope.epochAccessKey = buf(scope.epochAccessKey);
