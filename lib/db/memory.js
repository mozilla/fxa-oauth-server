...
MemoryStore.prototype = {
  ...
  /** Keys **/
  setDerivedKey: function setDerivedKey(userAndClientId, bundle) {
    this.derivedKeys[userAndClientId] = {
      bundle: bundle
    };
    return P.resolve();
  },
  getDerivedKey: function getDerivedKey(userAndClientId) {
    var keys = this.derivedKeys[userAndClientId];
    return P.resolve({
      bundle: keys.bundle
    });
  },
