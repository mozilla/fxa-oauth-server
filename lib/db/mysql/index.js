...
const QUERY_SCOPES_INSERT =
  'INSERT INTO scopes (scope, description, canGrantScopedKeys) ' +
  'VALUES (?, ?, ?);';
...
MysqlStore.prototype = {
  ...
  getScope: function getScope (appScope) {
    return this._readOne(QUERY_SCOPE_FIND, [appScope]);
  },

  registerScope: function registerScope (appScope) {
    return this._write(QUERY_SCOPES_INSERT, [
      appScope.scope,
      appScope.description,
      appScope.canGrantScopedKeys
    ]);
  },
