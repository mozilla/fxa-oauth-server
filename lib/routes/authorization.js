...
const SHA256_CHALLENGE_METHOD = 'S256'; // This server only supports S256 PKCE, no 'plain'
...
function generateCode(claims, client, scope, req) {
  return db.generateCode({
    ...
    // PKCE options
    code_challenge_method: req.payload.code_challenge_method,
    code_challenge: req.payload.code_challenge,
...
module.exports = {
  validate: {
    payload: {
      ...
      code_challenge_method: Joi.string().valid(SHA256_CHALLENGE_METHOD).optional(),
