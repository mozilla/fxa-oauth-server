...
AppError.mismatchCodeChallenge = function mismatchCodeChallenge(code_challenge) {
  return new AppError({
    code: 400,
    error: 'Bad Request',
    errno: 117,
    ...
    requestCodeChallenge: code_challenge
  });
};

AppError.missingPkceParameters = function invalidScopes() {
  return new AppError({
    code: 400,
