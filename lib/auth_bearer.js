...
exports.AUTH_STRATEGY = 'oauthToken';
exports.AUTH_SCHEME = 'bearer';
exports.MODE = 'try';

exports.SCOPE_CLIENT_MANAGEMENT = 'profile';

exports.strategy = function() {
  return {
    authenticate: function authBearerStrategy(req, reply) {
      if (AUTHENTICATED_PATHS.indexOf(req.path) === -1) {
        // Skip here if a path does not need to be validated. only client-tokens paths need auth.
      }
